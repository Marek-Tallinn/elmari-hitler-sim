...
def run_game():
    ...
    while True:
        func.check_events(gm_settings, screen, player, coins, robbers, terrorists, stars, powerups, hearts, timestop_coins, bosses, gas_missiles, stats, sb, play_button, menu_buttons)
        ...
        func.update_screen(gm_settings, screen, player, coins, timestop_coins, robbers, terrorists, stars, powerups, hearts, bosses, gas_missiles, clock, sb, play_button, menu_buttons, stats)
