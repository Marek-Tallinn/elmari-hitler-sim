...
def check_events(game_settings, screen, player, coins, robbers, terrorists, stars, powerups, hearts, timestop_coins, bosses, gas_missiles, stats, sb, play_button, menu_buttons):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            groups = [coins, robbers, terrorists, stars, powerups, hearts, timestop_coins, bosses, gas_missiles]
...
def update_screen(game_settings, screen, player, coins, timestop_coins, robbers, terrorists, stars, powerups, hearts, bosses, gas_missiles, clock, sb, play_button, menu_buttons, stats):
    player.blit_me()

    sprite_groups = [coins, timestop_coins, robbers, terrorists, stars, powerups, hearts, bosses, gas_missiles]
